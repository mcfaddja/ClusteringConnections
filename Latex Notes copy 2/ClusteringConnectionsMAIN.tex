...
\chapter{SVD Signs}
\subfile{PartII/Chapter5/5-0-SVDsigns}

\section{Finding $k$}
\subfile{PartII/Chapter5/5-1-FindingK}

\section{Compare Row Sign Patters}
\subfile{PartII/Chapter5/5-2-RowSignPattern}

\section{Complete Row Cluster Sets}
\subfile{PartII/Chapter5/5-3-CompleteUkSets}

\section{Single Sets for each Row Cluster}
\subfile{PartII/Chapter5/5-4-FinalUk}

\section{Compare Column Sign Patters}
\subfile{PartII/Chapter5/5-5-ColSignPattern}

\section{Complete Column Cluster Sets}
\subfile{PartII/Chapter5/5-6-CompleteVkSets}

\section{Single Sets for each Column Cluster}
\subfile{PartII/Chapter5/5-7-FinalVk}


\chapter{SVD Gaps}
\subfile{PartII/Chapter6/6-0-SVDgaps}



\chapter{CbC Disjoint Sets}
\subfile{PartII/Chapter7/7-0-DisjointSets}

\section{Compute $\mat{A}_U$}
\subfile{PartII/Chapter7/7-1-ComputeAu}

\section{Construct $\mathbb{U}$}
\subfile{PartII/Chapter7/7-2-ConstructU}

%\newpage
\section{Complete the $\mathbb{U}$ Sets}
\subfile{PartII/Chapter7/7-3-CompleteU}

\newpage
\section{Construct the $\mathbb{U}^\star$ Sets}
\subfile{PartII/Chapter7/7-4-FinalU}

\section{Compute $\mat{A}_V$}
\subfile{PartII/Chapter7/7-5-ComputeAv}

\section{Construct $\mathbb{V}$}
\subfile{PartII/Chapter7/7-6-ConstructV}

\newpage
\section{Complete the $\mathbb{V}$ Sets}
\subfile{PartII/Chapter7/7-7-CompleteV}

\newpage
\section{Construct the $\mathbb{V}^\star$ Sets}
\subfile{PartII/Chapter7/7-8-FinalV}
...
\subfile{PartII/Chapter8/8-0-NonDisjointSets}
